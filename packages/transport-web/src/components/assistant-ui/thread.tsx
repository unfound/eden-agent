...
export const Thread: FC = () => {
  return (
    ...
    >
      ...
      >
        {/* 消息内容区 — 不再设 overflow-y-auto，Viewport 本身就是滚动容器 */}
        ...
        {/* 输入框脚注 — sticky 固定在滚动容器底部 */}
        <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 z-10 flex flex-col gap-4 rounded-t-(--composer-radius) bg-background pb-4 md:pb-6">
          <div className="relative mx-auto w-full max-w-(--thread-max-width) px-4">
